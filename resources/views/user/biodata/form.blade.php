    ...
    <div class="max-w-4xl mx-auto p-6 rounded-xl shadow-lg bg-sky-950 text-white ring-1 ring-white/10">
        ...
        <form method="POST" action="{{ route('user.biodata.store') }}">
            ...
            <textarea name="alamat" id="alamat"
                ...
                {{ old('alamat', $biodata->alamat ?? '') }}
            </textarea>

            {{-- ID Desa --}}
            <x-input-label for="id_desa" value="Desa/Kelurahan" class="text-white" />
            ...
            {{-- Lama Menjabat --}}
            <x-input-label for="lama_menjabat" value="Lama Menjabat (dalam tahun)" class="text-white" />
